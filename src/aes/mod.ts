...
export class AES {
  ...
  constructor(
    ...
    const computedKey = typeof key === "string"
    ...
    this.ciper = new AESBlockCiper(computedKey, config);
    this.config = config;
  }

  encrypt(m: Uint8Array | string): RawBinary {
    const computedMessage = typeof m === "string"
  ...
  decrypt(m: Uint8Array): RawBinary {
